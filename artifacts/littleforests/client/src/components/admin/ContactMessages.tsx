...
const ContactMessages = () => {
  ...
  const { data: messages, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // contact_messages rows come straight from Supabase (snake_case columns),
      // not camelCase — created_at, not createdAt.
                ...
                <TableRow key={message.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span>{new Date(message.created_at ?? message.createdAt).toLocaleDateString()}</span>
                    </div>
                  </TableCell>
                  <TableCell>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-900">
                {new Date((selectedMessage as any).created_at ?? (selectedMessage as any).createdAt).toLocaleDateString()}
              </p>
            </div>
          </div>
          <div>
