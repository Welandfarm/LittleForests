...
const supabaseUrl =
  ...
  'https://mjsuwlpixcregiikiusd.supabase.co';
const supabaseAnonKey =
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY ||
  process.env.SUPABASE_ANON_KEY ||
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1qc3V3bHBpeGNyZWdpaWt1c2QiLCJyb2xlIjoiYW5vbiIsImlhdCI6MTc0OTQ2NzQ3NywiZXhwIjoyMDY1MDQzNDc3fQ.Anz7mqQLkGIMGcvPtfT1ELORA2DqEIHLsIge5DfQYxc';
