...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white">
      <SEO
        title="About Us — LittleForest Nursery | Restoring Kenya's Water Catchments"
        description="Learn about LittleForest Nursery's mission to restore water sources and degraded land in Bomet County, Kenya through indigenous tree planting, community partnerships, and agroforestry."
        path="/about"
      />
      {/* Header */}
