...
import { TreePine, Package, FileText, MessageSquare, Users, Home, Settings, SlidersHorizontal, Star, Image, Share2 } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <Tabs defaultValue="products" className="space-y-6">
          <TabsList className="flex flex-wrap h-auto gap-1 mb-8 bg-muted p-1 rounded-lg">
            ...
            <TabsTrigger value="content-social" className="flex items-center gap-1.5">
          ...
          <TabsContent value="content-social" className="mt-6">
            <ContentSocial />
          </TabsContent>
