...
const Blog = () => {
  ...
  const { data: blogPosts, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      // content rows come straight from Supabase (snake_case columns), so
      // sort/filter using created_at, not camelCase createdAt.
      return data
  ...
  return (
    <div className="min-h-screen bg-stone-50">
      <SEO
        title="Blog — LittleForest Nursery | Trees, Reforestation & Farming Tips"
        description="Read articles from LittleForest Nursery on indigenous trees, agroforestry, reforestation, and sustainable farming in Kenya."
        path="/blog"
      />
      {/* Header */}
