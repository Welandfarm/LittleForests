...
Please confirm availability and let me know`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white relative overflow-x-hidden">
      <SEO
        title="LittleForest Nursery — Indigenous Trees, Fruit Trees & Seedlings in Kenya"
        description="Buy indigenous trees, fruit trees, ornamental plants and organic honey from LittleForest Nursery in Bomet County, Kenya. Order via WhatsApp. Restoring water resources, one tree at a time."
        path="/"
      />
...
>>>>>>> 95c8ffdb2e9c18f0fccbce5e86f5122a9459e81f
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <DonateButton variant="solid" size="lg" className="px-8 py-3" alwaysShowLabel />
            </div>
          </div>
        </div>
      </section>
